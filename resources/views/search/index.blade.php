  ...
  <div class='container'>
    <div class='row'>
      ...
      <div class='col-md-9'> 
        ...
        <h4>
            <b>Total Search  </b>
            <span class="badge badge-danger" style="background:#FF0000">{{ count($products) }}</span>
            Products
        </h4>
                              ...
                              <div class="cart clearfix animate-effect">
                                <div class="action">
                                  <ul class="list-unstyled">
                                    ...
                                    <button class="btn btn-primary icon" id="{{ $product->id }}" onclick="addToWishlist(this.id)" type="button"> <i class="fa fa-heart"></i> </button>                                    {{-- <li class="lnk"> <a class="add-to-cart" href="detail.html" title="Compare"> <i class="fa fa-signal"></i> </a> </li> --}}
                                  </ul>
                                </div>
                                <!-- /.action --> 
                              </div>
