		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
					<form method="post" action="{{ route('admin.adminuserrole.update', $admin->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="name" class="form-control" data-validation-required-message="This field is required" value="{{ $admin->name }}"> <div class="help-block"></div></div>
                                            @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="email" name="email" class="form-control" data-validation-required-message="This field is required" value="{{ $admin->email }}"> <div class="help-block"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>						
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="phone" class="form-control" data-validation-required-message="This field is required" value="{{ $admin->phone }}"> <div class="help-block"></div>
                                        </div>
                                        {{-- <div class="form-control-feedback"><small>Add <code>required</code> attribute to field for required validation.</small></div> --}}
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="controls">
                                            <fieldset>
                                                <input type="checkbox" id="checkbox_6" name="shipping" value="1" {{ $admin->shipping == 1 ? ' checked' : '' }}>
                                                <label for="checkbox_6">Shipping</label>
                                            </fieldset>
                                            <fieldset>
                                                <input type="checkbox" id="checkbox_7" name="blog" value="1" {{ $admin->blog == 1 ? ' checked' : '' }}>
                                            ...
                                            <fieldset>
                                                <input type="checkbox" id="checkbox_9" name="returns" value="1" {{ $admin->returns == 1 ? ' checked' : '' }}>
                                                <label for="checkbox_9">Returns</label>
                                            </fieldset>
                                            <fieldset>
                                                <input type="checkbox" id="checkbox_10" name="reviews" value="1" {{ $admin->reviews == 1 ? ' checked' : '' }}>
