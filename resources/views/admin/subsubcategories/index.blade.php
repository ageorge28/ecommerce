                ...
                <div class="col-8">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Sub Sub Categories <span class="badge badge-pill badge-danger">{{ count($subsubcategories) }}</span></h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                    ...
                                    <tbody>
                                        @foreach ($subsubcategories as $subsubcategory)
                                            <tr>
                                                ...
                                                <td>{{ $subsubcategory->name_hin }}</td>
                                                <td>
                                                    <a href="{{ route('admin.subsubcategories.edit', $subsubcategory->id) }}" class="btn btn-info" title="Edit"><i class="fas fa-edit"></i></a>
                                                    <a id="delete" href="{{ route('admin.subsubcategories.delete', $subsubcategory->id) }}" class="btn btn-danger" title="Delete"><i class="fa fa-trash"></i></a>
                                                </td>
