                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="name_en" id="name_en" class="form-control"
                                                required="" value="{{ $subCategory->name_en }}" data-validation-required-message="This field is required">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="name_hin" id="name_hin" class="form-control"
                                                required="" data-validation-required-message="This field is required" value="{{ $subCategory->name_hin }}">
                                            <div class="help-block"></div>
                                        </div>
                                        @error('name_hin')
                                            <div class="form-control-feedback"><small>{{ $message }}</small></div>
