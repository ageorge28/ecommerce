            ...
            <div class="row">
                            ...
                            <div class="table-responsive">
                                <form method="post" action="{{ route('admin.reports.date') }}">
                                    ...
                                    <div class="form-group">
                                        <h5>Select By Date<span class="text-danger">*</span></h5>
                                        <div class="controls">
                ...
                <div class="col-4">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <form method="post" action="{{ route('admin.reports.month') }}">
                                    @csrf
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <select name="year_month" id="year_month" class="form-control">
                ...
                <div class="col-4">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <form method="post" action="{{ route('admin.reports.year') }}">
                                    @csrf
                                    <div class="form-group">
                                        <h5>Select Year<span class="text-danger">*</span></h5>
                                        <div class="controls">
