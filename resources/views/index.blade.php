            ...
            <div class="item" style="background-image: url({{ asset('frontend/images/sliders/01.jpg') }});">
              <div class="container-fluid">
                <div class="caption bg-color vertical-center text-left">
                  ...
                  <div class="big-text fadeInDown-1"><span style="color:lightgrey">New</span> <span class="highlight">Collections</span></div>
                  <div class="excerpt fadeInDown-2 hidden-xs"> <span style="color:lightgrey">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</span> </div>
            ...
            <div class="item" style="background-image: url({{ asset('frontend/images/sliders/02.jpg') }});">
              <div class="container-fluid">
                <div class="caption bg-color vertical-center text-left">
                  ...
                  <div class="big-text fadeInDown-1"><span style="color:lightgrey">Women</span> <span class="highlight">Fashion</span> </div>
                  <div class="excerpt fadeInDown-2 hidden-xs"> <span style="color:lightgrey">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit</span> </div>
                  <div class="button-holder fadeInDown-3"> <a href="index.php?page=single-product" class="btn-lg btn btn-uppercase btn-primary shop-now-button">Shop Now</a> </div>
                </div>
                <!-- /.caption --> 
              </div>
