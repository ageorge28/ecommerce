...
@section('title')
  Products By Subcategory | Easy Online Shop
@endsection
  ...
  <div class="container">
    <div class="breadcrumb-inner">
      <ul class="list-inline list-unstyled">
        <li><a href="{{ route('home') }}">Home</a></li><li><a href="">{{ session()->get('language') == 'Hindi' ? $subcategory->category->name_hin : $subcategory->category->name_en }}</a></li>
        <li class='active'>
